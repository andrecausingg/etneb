        ...
        <section class="yot-mlr-16 dashboard-right" style="align-self: flex-start;">
            ...
            <div class="yot-bg-white yot-tc-black yot-pa-24 yot-mb-16" style="border-radius: 20px; ">
                ...
                <div class="yot-mb-16 yot-flex yot-flex-ai-c-jc-sb">
                    <a  href="dashboard-profile-security-info" class="yot-flex yot-flex-ai-c yot-cursor-pointer yot-tc-black">
                ...
                <div class="yot-text-center yot-mb-16">
                    <!-- Image -->
                    <img src="./app/images/undraw_surveillance_re_8tkl.svg" alt="" width="126" height="126">
                </div>
                ...
                <div>
                    ...
                    <div class="yot-bg-white yot-flex yot-flex-fd-c yot-pa-16">
                        ...
                        <input class="yot-form-input-primary-bg-white yot-w-100"  type="email" name="" id="">
                    </div>
                    <!-- First Name -->
                    <div class="yot-bg-white yot-flex yot-flex-fd-c yot-pa-16">
                        <label for="">Confirm New Password</label>
                        <input class="yot-form-input-primary-bg-white yot-w-100"  type="password" name="" id="">
                    </div>
